...
'''
The following file has been copied and modified from https://github.com/EFS-OpenSource/calibration-framework 
...
class ReliabilityDiagram(object):
    ...
    def __plot_confidence_histogram(
        ...
        if title_suffix is not None:
            ax.set_title('Confidence Histogram - ' + title_suffix, fontsize=9)
        else:
        ...
        if title_suffix is not None:
            ax.set_title('Reliability Diagram' + " - " + title_suffix, fontsize=9)
        else:
